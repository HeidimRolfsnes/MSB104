...
Portugal2010 <- gdppop2010 %>%
  filter(nuts0=="PT")
ggplot()+
  geom_line(data = gdppop2010, mapping = aes(x = Gini , y = nuts0))
...
lm.1 = lm(Gini_2 ~ gdp_per_capita, data = Denmark2010)
lm.2 = lm(Gini_2 ~ gdp_per_capita, data = France2010)
lm.3 = lm(Gini_2 ~ gdp_per_capita, data = HungarySlovakia2010)
lm.4 = lm(Gini_2 ~ gdp_per_capita, data = Portugal2010)
lm.5 = lm(Gini_2 ~ gdp_per_capita, data = gdppop2010)
...
As we can see from the formula above...... 
