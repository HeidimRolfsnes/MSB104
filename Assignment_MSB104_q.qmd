...
Briefly about what we found in the summary @tbl-1. We found the min and the max values. i.e. the smallest and the highest GDP per capita for the countries. We also found 1st quartile and 3rd quartile. The first quartile was the observation between the median and the lowest value, and looks at the 25% lowest values from the 75% highest. The median looks at the value that is observed the most times in the middle of the observations. The third quartile is then, naturally enough, the value between the median and the highest value.We have also look at mean which told us what the average observation for all regions was.
...
The three Whealties regions @tbl-3 in Denmark are Kobenhagen (DK011), Kobenhagen area (DK012) and Sydjylland (DK032).
The three least wealtiest regions @tbl-4 in Denmark are Vest- og Sydjælland (DK022), Bornholm (DK014) and Østsjælland (DK021).
...
After the FRY regions have been removed, we are left with 96 nuts3 regions. The three wealtiest regions @tbl-8 are Paris (FR101), Hauts-de-seine (FR105) and Rhône (FRK26). Paris og Hauts-de-seine stands out clarly from the other region with a difference of approximately 50,000 Euro GDP pr capita.
The three poorest regions @tbl-9 Creuse (FRI22), Ariège (FRJ21) and  Meuse(FRF32). These regions have quite the same GDP pr capita. 
...
Hungary and Slovakia has 28 regions together. The three whealties @tbl-11 are Bratislava (SK010), Budapest (HU110) and Trnava (SK021). The capitals of both countries have the richest region. The least wheltiest regions @tbl-12 are Nògràd(HU313), Szabolcs-Szatmàr-Bereg(HU323). We can see that the three poorest regions belong to Hungary. which means that they have a lower GDP per capita than Slovakia in the poorest regions. We see that there is a difference between min and max in the regions of Hungary. 

There is a difference of approximately 25,000 Euro between the whealties and poorest regions in Hungary. Based on these observations, Bratislava is the richest region, since we do not see any of Slovakia's regions among the lowest, we can assume that Slovakia has a higher GDP per capita than Hungary has for its inhabitants.
