...
Hears the refrence to the table @tbl-des_2010
...
The p values for Only France and Interaction are both zero, which is initially very unlikely. We cannot therefore say that this is a pattern but a random coincidence. No France is very close to one, which means that we can see more connections there.
